...
(function() {
  var addCouple, addDance, addJudge, calculateCoupleMarks, calculateInter, calculateJudgeMarks, calculateMaxSums, couples, dances, generateCoupleMarks, generateInter, generateJudgeMarks, generateMarks, judges, marks, removeCouple, removeDance, removeJudge, sortCoupleMarks, sortJudgeMarks, validateMarks;
  ...
  $(function() {
    ...
    return $('#coupleMarksGen').click(function() {
